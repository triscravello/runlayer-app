...
import type { ProductVariant, RecommendationScoreBreakdown as ScoreBreakdown, ScoredRecommendationItem, WeatherCondition, Intensity, Terrain } from "@/lib/engine/types/recommendationEngine";
import type { UserProfile } from "@/lib/types/user";
import { ArrowLeft, Award, BookmarkPlus, CheckCircle2, ChevronRight, CloudSnow, ExternalLink, Gauge, Layers, RefreshCw, Sparkles } from "lucide-react";
...
function mapRecommendation(item: ScoredRecommendationItem, index: number): RankedGearRecommendation {
  ...
  return {
    ...
    selectedVariant: item.item.selectedVariant,
  };
}
